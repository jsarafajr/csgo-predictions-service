...
var skel = function() {
    var e = "config",
        ...
        st = "string",
        ot = "DOMContentLoaded",
        ut = "getDevicePixelRatio",
        at = "_skel_attach",
        ft = "getViewportDimensions",
        lt = "states",
        ct = "matchMedia",
        ht = "ios",
        ...
        Ut = {
            ...
            getDevicePixelRatio: function() {
                ...
                if (Ut[g][l] == ht || Ut[g][l] == "mac" || Ut[g][l] == Nt || Ut[g][l] == rt && e[y](/Safari\/([0-9]+)/) && parseInt(RegExp.$1) >= 537) return 1;
                if (window[z] !== undefined && !e[y](/(Firefox; Mobile)/)) return window[z];
                if (window[ct]) {
                    if (window[ct]("(-webkit-min-device-pixel-ratio: 2),(min--moz-device-pixel-ratio: 2),(-o-min-device-pixel-ratio: 2/1),(min-resolution: 2dppx)").matches) return 2;
                    if (window[ct]("(-webkit-min-device-pixel-ratio: 1.5),(min--moz-device-pixel-ratio: 1.5),(-o-min-device-pixel-ratio: 3/2),(min-resolution: 1.5dppx)").matches) return 1.5
                }
                return 1
            },
            getLevel: function(e) {
            ...
            getViewportDimensions: function() {
                var t, n, r, i;
                return t = window.orientation !== undefined ? Math.abs(window.orientation) : u, n = Ut[ut](), r = document[K].clientWidth, i = document[K].clientHeight, screen[S] < r && (r = screen[S], i = screen[m]), t !== u && (Ut[e][pt] ? (r = Math.min(screen[S], screen[m]), i = Math.max(screen[S], screen[m])) : t === 90 ? (r = Math.max(screen[S], screen[m]), i = Math.min(screen[S], screen[m])) : (r = Math.min(screen[S], screen[m]), i = Math.max(screen[S], screen[m]))), r /= n, i /= n, {
                    width: r,
                    height: i
                }
            },
            ...
            reverseRows: function(e) {
                ...
                Ut[n](t, function(n) {
                    if (n === c) return;
                    var r = t[n];
                    if (r[O] || e > 0 && r[_][y](/\bno-collapse-([0-9])\b/) && parseInt(RegExp.$1) >= e) return;
                    var i = r.children,
                        s;
            ...
            changeState: function(l) {
                ...
                if (!Ut[T][lt][Ut[s]]) {
                    Ut[T][lt][Ut[s]] = {
                        ...
                        elements: [],
                        values: {}
                    }, m = Ut[T][lt][Ut[s]], Ut[s] === Ut.sd ? h = [] : h = Ut[s][V](1)[Ft](Ut.sd), Ut[H](m[e], Ut[W][p]), Ut[n](h, function(n) {
                        Ut[H](m[e], Ut[t][h[n]][e])
                    });
                    switch (Ut[e].reset) {
                        case "full":
                ...
                Ut.detachAllElements(m[r]), Ut[Ot](m[r]), Ut[U](function() {
                    ...
                    Ut[e].RTL && (Ut.unreverseRows(), s > 0 && Ut.reverseRows(s)), Ut[g][X] > 8 && (r = "_skel_cell_important_placeholder", t = Ut[o]("skel-cell-important"), t && t[c] > 0 && Ut[n](t, function(e) {
                        ...
                        if (o < s) {
                            if (n[nt](r) && n[r] !== u) return;
                            i = n[Ct];
                            while (i && i.nodeName == "#text") i = i[Ct];
                            if (!i) return;
                            n[d][b](n, n[d][Et]), n[r] = i
                        } else n[nt](r) || (n[r] = u), i = n[r], i !== u && (n[d][b](n, i.nextSibling), n[r] = u)
                    }))
            ...
            initConfig: function(i) {
                ...
                typeof i == x && (i[t] && (Ut[e][t] = {}), Ut[H](Ut[e], i)), Ut[H](Ut[W][p].grid, Ut[e].grid), Ut[W][p][L] = Ut[e][L], Ut[n](Ut[e][t], function(n) {
                    ...
                    Ut[H](s, Ut[e][t][n]), xt in s || (s[xt] = Ut[W][p][xt]), m in s || (s[m] = Ut[W][p][m]), "range" in s ? s[S] = s.range : S in s || (s[S] = Ut[W][p][S]), Ut[e][t][n] = s, i = {}, Ut[H](i, Ut[W].breakpoint), i[e] = Ut[e][t][n], i.test = {
                        width: a(n + "w", i[e][S]),
                        height: a(n + "h", i[e][m])
                    }, i[r] = [], Ut[e].prefix && i[e][xt] !== u && (i[e][xt] = Ut[e].prefix + "-" + n + ".css"), i[e][xt] === "" && (i[e][xt] = u), Ut[e].preload && i[e][xt] && o[$](i[e][xt]), Ut[t][n] = i, Ut.breakpointList[$](n)
            ...
            initUtilityMethods: function() {
                document[J] ? ! function(e, t) {
                    ...
                    if (!e) return [];
                    var n;
                    for (n in e) Object[kt][nt].call(e, n) && t(n)
                }
            },
            initAPI: function() {
                var e, t, r = navigator.userAgent;
                Ut[g][X] = 99, e = "other", r[y](/Firefox/) ? e = "firefox" : r[y](/Chrome/) ? e = "chrome" : r[y](/Safari/) && !r[y](/Chrome/) ? e = "safari" : r[y](/(OPR|Opera)/) ? e = "opera" : r[y](/MSIE ([0-9]+)/) ? (e = "ie", Ut[g][X] = RegExp.$1) : r[y](/Trident\/.+rv:([0-9]+)/) && (e = "ie", Ut[g][X] = RegExp.$1), Ut[g].browser = e, Ut[g][l] = "other", t = {
